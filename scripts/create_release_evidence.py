...
def build_evidence(risk_profile: str, commit_sha: str, workflow_run: str) -> ReleaseEvidence:
...
def main() -> None:
    ...
    evidence = build_evidence(args.risk_profile, args.commit_sha, args.workflow_run)
